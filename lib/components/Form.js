...
var Form = function (_Component) {
  ...
  function Form(props) {
    ...
    _this.onSubmit = function (event) {
      ...
      var focusedFormInput = document.activeElement;
    ...
    _this.onInnerSubmit = function () {
      if (!_this.props.noValidate) {
        ...
        (0, _utils.nullifyEmptyRequiredFields)(_this.props.schema, _this.props.uiSchema, formData);

        (0, _utils.setState)(_this, { formData: formData }, function () {
    ...
    _this.onInnerInnerSubmit = function () {
